...
-- This file was created by combining the H2 schema files from package org.springframework.batch.core
-- in spring-batch-core. If the jar version changes, there might be changes to the schema and this file might 
-- need to be updated.
